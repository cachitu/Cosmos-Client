...
public struct LegacyAddress: Address {
    ...
    public init(data: Data, type: AddressType, coin: HDCoin, base58: String, bech32: String, publicKey: Data?) {
        self.data = data
        self.type = type
        self.coin = coin
        self.base58 = base58
    ...
    public init(_ base58: Base58Check, coin: HDCoin) throws {
...
public struct Cashaddr: Address {
    ...
    public init(data: Data, type: AddressType, coin: HDCoin, base58: String, bech32: CashaddrWithScheme, publicKey: Data?) {
        self.data = data
        self.type = type
        self.coin = coin
        self.base58 = base58
    ...
    public init(_ cashaddr: CashaddrWithScheme, coin: HDCoin) throws {
