...
var pJS=function(e,a){var t=document.querySelector("#"+e+" > .particles-js-canvas-el");
    ...
    i.fn.particle=function(e,a,t){
        if(this.radius=(i.particles.size.random?Math.random():1)*i.particles.size.value,
           ...
           this.x>i.canvas.w-2*this.radius?this.x=this.x-this.radius:this.x<2*this.radius
           ...
           this.color={},"object"==typeof e.value)if(e.value instanceof Array){
            ...
            this.color.rgb=hexToRgb(s)}else void 0!=e.value.r
                &&void 0!=e.value.g&&void 0!=e.value.b
                &&(this.color.rgb={r:e.value.r,g:e.value.g,b:e.value.b}),
                void 0!=e.value.h&&void 0!=e.value.s&&
                void 0!=e.value.l&&(this.color.hsl={h:e.value.h,s:e.value.s,l:e.value.l});
           else"random"==e.value?this.color.rgb={
           r:Math.floor(256*Math.random())+0,
           g:Math.floor(256*Math.random())+0,
               b:Math.floor(256*Math.random())+0}:"string"==typeof e.value
